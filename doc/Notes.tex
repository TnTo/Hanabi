...
\begin{itemize}
	\item 99 $a_\mu$ input
	\item 110 (arbitrary) sigmoid neurons of first hidden layer 
	\begin{flalign*}
	...
	\item 110 (still arbitrary) sigmoid neurons of second hidden layer 
	\begin{flalign*}
...
\begin{flalign*}
	C &= {\left| o_{\hat{\rho}} - {{s} \over 25}\right| }^{\alpha n} = {\left| \sigma_m \left( {{w^o}^\nu_{\hat{\rho}}} \cdot \sigma \left( { {{w^2}_\nu^\lambda} \cdot \sigma \left( { {{w^1}_\lambda^\mu} a_\mu + {{b^1}_\lambda}}\right) + {{b^2}_\nu}}\right) + {{b^o}_{\hat{\rho}}} \right) - {{s} \over 25}\right| }^{\alpha n} = \\
	&= {\left| {{exp\left( {{w^o}^\nu_{\hat{\rho}}} {\left( {1 + exp \left( { - {{w^2}_\nu^\lambda} {\left( {1 + exp \left( { - {{w^1}_\lambda^\mu} a_\mu - {{b^1}_\lambda}}\right) }\right) }^{-1} - {{b^2}_\nu}} \right) }\right) }^{-1} + {{b^o}_{\hat{\rho}}}\right) } \over {\sum_\rho {exp\left( {{w^o}^\nu_\rho} {\left( {1 + exp \left( { - {{w^2}_\nu^\lambda} {\left( {1 + exp \left( { - {{w^1}_\lambda^\mu} a_\mu - {{b^1}_\lambda}}\right) }\right) }^{-1} - {{b^2}_\nu}} \right) }\right) }^{-1} + {{b^o}_\rho}\right) }}} - {s \over 25}\right| }^{\alpha n}
\end{flalign*}
...
So follow that:
\begin{flalign*}
	{\partial C} \over {\partial {b^o}} &= {\alpha n \over { {o - {s \over 25}}}} C(o) {\partial \sigma_m (z^o) \over \partial {b^o}} = {\alpha n \over { {o - {s \over 25}}}} C(o) \sigma_m(z^o) (1-\sigma_m(z^o))\\
	\partial C \over \partial {w^o}^\mu &= {\alpha n \over { {o - {s \over 25}}}} C(o) {\partial \sigma_m (z^o) \over \partial {w^o}^\mu} = {\alpha n \over { {o - {s \over 25}}}} C(o) \sigma_m(z^o) (1-\sigma_m(z^o)){h^2}_\mu = {{\partial C} \over {\partial {b^o}}}  {h^2}_\mu \\
	\partial C \over \partial {b^2} &= {\alpha n \over { {o - {s \over 25}}}} C(o) { \partial \sigma_m (z^o) \over \partial {b^2}} = \\
	&= {\alpha n \over { {o - {s \over 25}}}} C(o) \sigma_m(z^o) (1-\sigma_m(z^o)) ({w^o}^\mu \sigma({z^2}_\mu) (1-\sigma({z^2}_\mu)) = \\
	&= {{\partial C} \over {\partial {b^o}}}  ({w^o}^\mu \sigma({z^2}_\mu) (1-\sigma({z^2}_\mu)) \\
	{\partial C} \over {\partial {w^2}^\nu} &= {\alpha n \over { {o - {s \over 25}}}} C(o) { \partial \sigma_m (z^o) \over \partial {w^2}^\nu} = \\
	&= {\alpha n \over { {o - {s \over 25}}}} C(o) \sigma_m(z^o) (1-\sigma_m(z^o)) ({w^o}^\mu \sigma({z^2}_\mu) (1-\sigma({z^2}_\mu)){h^1}_\nu = {{\partial C} \over {\partial {b^2}}} {h^1}_\nu  \\
	\partial C \over \partial {b^1} &= {\alpha n \over { {o - {s \over 25}}}} C(o) { \partial \sigma_m (z^o) \over \partial {b^1}} = \\
	&= {\alpha n \over { {o - {s \over 25}}}} C(o) \sigma_m(z^o) (1-\sigma_m(z^o)) ({w^o}^\mu \sigma({z^2}_\mu) (1-\sigma({z^2}_\mu)) ({w^2}^\nu \sigma({z^1}_\nu) (1-\sigma({z^1}_\nu)) = \\
	&= {{\partial C} \over {\partial {b^2}}}  ({w^2}^\nu \sigma({z^1}_\nu) (1-\sigma({z^1}_\nu)) \\
	\partial C \over \partial {w^1}^\tau &= {\alpha n \over { {o - {s \over 25}}}} C(o) { \partial \sigma_m (z^o) \over \partial {w^1}^\tau} = \\
	&= {\alpha n \over { {o - {s \over 25}}}} C(o) \sigma_m(z^o) (1-\sigma_m(z^o)) ({w^o}^\mu \sigma({z^2}_\mu) (1-\sigma({z^2}_\mu)) ({w^2}^\nu \sigma({z^1}_\nu) (1-\sigma({z^1}_\nu))a_\tau = \\
