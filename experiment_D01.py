...
if os.path.exists(NAME):
    ...
    hidden1 = keras.layers.Dense(256, activation="softplus")(inputs)
    drop1 = keras.layers.Dropout(rate=0.2, seed=SEED)(hidden1)
    hidden2 = keras.layers.Dense(256, activation="softplus")(drop1)
